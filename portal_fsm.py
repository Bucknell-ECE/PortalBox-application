...
class RunningNoCard(State):
    ...
    def on_enter(self, input_data):
        ...
        self.grace_start = datetime.now()
        self.service.box.flash_display(self.service.settings["display"]["no_card_grace_color"],self.grace_delta.seconds,5)
        self.service.box.start_beeping(self.grace_delta.seconds)
