...
#
#
#    Modified on 7/22/2021 by James Howe(jah083@bucknell.edu) to fix a syntax
#    error in the while loop in the function MFRC522_ToCard() which used BITWISE
#    operators instead of logical operators 
